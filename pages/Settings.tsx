          ...
          {activeTab === 'paper' && (
            <div className="space-y-6">
               ...
               <div className="flex flex-col lg:flex-row gap-6 lg:h-[700px]">
                  <div className="flex-1 bg-gray-200 rounded-2xl overflow-auto p-0 flex justify-center relative shadow-inner min-h-[400px]">
